...
export interface TestSignatureAggregatorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addStake"
      | "aggregateSignatures"
...
export interface TestSignatureAggregator extends BaseContract {
  connect(runner?: ContractRunner | null): TestSignatureAggregator;
  ...
  ): TypedContractMethod<[arg0: UserOperationStruct], [string], "view">;
